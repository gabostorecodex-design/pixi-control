...
public class ConversationService extends Service implements TextToSpeech.OnInitListener {
    ...
    private String localReply(String value) { String t = value.toLowerCase(Locale.ROOT); if (t.contains("hola") || t.contains("buenas")) return "Hola. Estoy aquí contigo."; if (t.contains("gracias")) return "De nada. Para eso estoy."; if (t.contains("quien eres") || t.contains("quién eres")) return "Soy Pixi, tu mascota robot."; return "Te escuché. Ahora mismo estoy en modo local, pero sigo aquí."; }
