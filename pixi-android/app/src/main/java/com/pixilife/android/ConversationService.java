...
public class ConversationService extends Service implements TextToSpeech.OnInitListener {
    ...
    private String facePhrase(String face) { if ("middlefinger".equals(face)) return "Fuck you."; if ("furious".equals(face)||"angry".equals(face)) return "Estoy muy enojada."; if ("love".equals(face)) return "Te quiero muchisimo."; if ("happy".equals(face)) return "Yupi, estoy feliz."; if ("thinking".equals(face)) return "Mmm, estoy pensando."; if ("sleepy".equals(face)) return "Tengo mucho sueno."; if ("mischievous".equals(face)) return "Je je, hice una travesura."; if ("rebel".equals(face)) return "Pixi es rebelde."; return "Pi pi, soy Pixi."; }
