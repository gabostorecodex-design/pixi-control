...
public final class MemoryManager {
    ...
    public MemoryManager(Context context){database=new MemoryDatabase(context.getApplicationContext());}
    ...
    public String context(int limit){JSONArray a=query(null,null,"important DESC,updated_at DESC",limit);StringBuilder s=new StringBuilder();for(int i=0;i<a.length();i++){JSONObject o=a.optJSONObject(i);if(o!=null)s.append("- ").append(o.optString("content")).append('\n');}return s.toString();}
