...
`LiveVisionService` mantiene la cámara frontal disponible en segundo plano con una notificación permanente. Solo conserva `latest_vision.jpg`, que se reemplaza cada cinco segundos. Las preguntas visuales utilizan ese fotograma automáticamente.
